...
document.body.innerHTML = `       <div style="
        ...
        text-align:center;
        padding:20px;
      ">         <div>           <div style="font-size:70px;font-weight:bold;color:#00d4ff;margin-bottom:20px;">
            HEADLOCK           </div>           <h2 style="margin:0 0 15px">APP ĐANG NÂNG CẤP</h2>           <p style="opacity:.8">
            Phiên bản mới đang được cập nhật.<br>
            Vui lòng quay lại sau.           </p>           <div style="margin-top:25px;color:#00ff88;font-size:14px;">
            © HEADLOCK JAME           </div>         </div>       </div>
    `;
});
...
style.textContent = `     .crosshair-dot::before,
    .crosshair-dot::after {
      background: ${color};
